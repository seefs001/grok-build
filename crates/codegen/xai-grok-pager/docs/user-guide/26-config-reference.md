...
| `models.reasoning_summary` | `none / auto / concise / detailed` | `yes` | `user` | Fork: global fallback for Responses `reasoning.summary`; `model.<id>.reasoning_summary` wins when set. Default concise. |
